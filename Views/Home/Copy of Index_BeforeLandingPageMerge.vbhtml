       ...
       <div class="howtopopup" id="w_howtotutorial" style="display:none;">                
                ...
                <div class="slidecontainer">
                    ...
                    <div id="w_howtoslide2" class="howtoslide" style="display:block;">
                        <h2 style="text-align:center;">Welcome to Training, Let's start with a Warm-Up!</h2>             
                        <p><img src="https://d2q72sm6lqeuqa.cloudfront.net/images/coach.png" border="0" alt="Coach" style="margin:0px 10px 15px 10px; float:left;"/> The aim of KING OF THE KOP is to Predict what event happens next in the match! You win credits by predicting correctly, and the more you win the further you go up the leaderboard!</p>
                        <p>If you find yourself struggling at the bottom of the table use Powerplays and Forfeits to your advantage. One big win can change the game!</p>
                        <br /><span onClick='showslide(3);return false;' class='navbtn'>Next Drill <strong>&#8250;</strong></span>                        
                    </div>
                     ...
                     <div class="promo">        
                      <div style="width:100%;">
                        ...
                        <div style="float:left; width:63%; height:500px; position:relative; text-align:right;">
                          <img src="https://d2q72sm6lqeuqa.cloudfront.net/images/intro-3d-text-v2.png" border="0" alt="What Happens Next?" style="position:relative; top:30px; max-width:100%;">	                          
                        </div>
                        ...
                        <div style="float:right; width:360px; max-width:36%; height:500px; background:#0e1013; box-shadow:inset 0px 5px 10px #000;">    
                              ...
                              <div class="panelheader"><img src="https://d2q72sm6lqeuqa.cloudfront.net/images/tracker-icon.png" border="0" style="vertical-align:middle;" /> Game Tracker</div>
			 ...
			 <div><span onclick="cancel_registration();" style="font-weight:bold; padding:0.5em; cursor:pointer; display:block;">OK</span></div>
                     ...
                     <div class="navbar" style="position:relative;">
                         <!-- registration link -->
                              ...
                              @* <div style="position: absolute;bottom: -96px;text-shadow: 0px 1px rgba(245, 240, 240, 1);font-size: 3.3em;  left: 36%; color: #fff;">live.trust5.com</div>
                         *@
	                           <!--/ registration link -->

                                <div style="position:absolute; left:5px; top:5px;"><img src="https://d2q72sm6lqeuqa.cloudfront.net/images/kingkop-logo-2.png" /></div>
                                <span class="nav" onClick="showhowtoplay();"><img src="https://d2q72sm6lqeuqa.cloudfront.net/images/navbar-icon1.png" alt="How to play" border="0" /> <span>How to<br/>play</span></span>
                                ...
                                <span class="nav" onClick="showtech();" style="border-left:none;"><img src="https://d2q72sm6lqeuqa.cloudfront.net/images/navbar-icon2.png" alt="How can I play?" border="0" /> <span>Browser<br/>Support</span></span>
                     </div>   
                 </div>
...
<div id="m_registration_form" style="display:none;">
		 ...
		 <!-- register screen - shown by default -->
		 <div id="m_register">
			 <div id="m_registerdetails">Enter your email address and password to Register to Play.</div>
			 <fieldset>
                 <input type="text" placeholder="Nick Name"  id="m_username" />
				 <input type="email" placeholder="Email" id="m_email"  />
				 <input type="password" placeholder="Password" id="m_pass1"  />
				 <input type="password" placeholder="Confirm Password" id="m_pass2" />
				 <input type="submit" value="Register" onClick="Login.Register(); return false;" />
			 </fieldset>
			 <div><span onclick="cancel_registration();" style="font-weight:bold; padding:0.5em; cursor:pointer; display:block;">Cancel X</span></div>
		 </div>
		 ...
		 <div id="m_login" style="display:none;">
			 <div id="m_logindetails">Enter your registered email address and password to Sign In to Play.</div>
			 <fieldset>
				 <input type="email" placeholder="Email" id="m_email_login" />
				 <input type="password" placeholder="Password" id="m_pass_login" />
				 <input type="submit" value="Sign In" onClick="Login.Login(@ViewBag.fixtureID); return false;" />
                  <input type="checkbox" name="RememberMe" value="1" id="m_rm"> Remember Me<br>
			 </fieldset>

			 <div>
                 <span onclick="forgot_pass();" style="font-weight:bold; padding:0.5em; cursor:pointer; display:inline-block;">Forgot Password</span>
                  / 
                 <span onclick="cancel_registration();" style="font-weight:bold; padding:0.5em; cursor:pointer; display:inline-block;">Cancel X</span>
		 ...
		 <div id="m_forgotpass" style="display:none;">
			  <div id="m_resenddetails">Enter your registered email address</div>
			 <fieldset>
				 <input type="email" placeholder="Email" id="m_rsemail" />
				 <input type="submit" value="Send Password" onclick="Login.ResendPassword(); return false;" />
			 </fieldset>
			 <div><span onclick="cancel_registration();" style="font-weight:bold; padding:0.5em; cursor:pointer; display:block;">Cancel X</span></div>
		 </div>

         <div id="m_passResent" style="display:none;">
			 Password sent - check your inbox!!
			 <div><span onclick="cancel_registration();" style="font-weight:bold; padding:0.5em; cursor:pointer; display:block;">OK</span></div>
		 </div>
	</div>
                        ...
                        <div style="background:#b50909; padding:0.5em;">
                          ...
                          <div class="column_tracker">
                              <img src="https://d2q72sm6lqeuqa.cloudfront.net/images/intro-3d-text-v2.png" border="0" alt="What Happens Next?" style="max-width:100%; max-height:100%;">	                              
                          </div>
                          ...
                          <img class="fcrest" src="@ViewBag.fixturecrest" border="0" alt="What Happens Next?" style="width:90%; margin:auto;" />	
                          <strong>@ViewBag.fixturedescription</strong>
